                                    ...
                                    <div class="navbar-notifications-menu__content" data-perfect-scrollbar>
                                        <div class="py-2">
                                            ...
                                            <div class="dropdown-item d-flex">
                                                ...
                                                <div class="flex">
                                                    <a href="">Test user</a> left a comment on <a href="">4Wheel</a><br>
                            ...
                            <li class="nav-item dropdown">
                                <a href="#account_menu" class="nav-link dropdown-toggle" data-toggle="dropdown"
                                    ...
                                    <span class="mr-1 d-flex-inline">
                                        <span class="text-light">test-user</span>
                                    </span>
                                    <img src="{{ asset('assets/images/avatar/demis.png') }}" class="rounded-circle"
                                        width="32" alt="Profile image">
                                </a>
                                <div id="account_menu" class="dropdown-menu dropdown-menu-right">
                                    <div class="dropdown-item-text dropdown-item-text--lh">
                                        <div><strong>test user</strong></div>
                                        <div class="text-muted">@testuser</div>
                                    </div>
