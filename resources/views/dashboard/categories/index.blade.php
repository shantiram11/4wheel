                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Categories Databale</h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                            <table id="categoriesDatatable" class="table table-bordered table-striped">
                                <thead>
                                <tr>
                                    <th>ID</th>
                                    <th>Name</th>
    ...
    <script>
        $(function(){
            $("#categoriesDatatable").DataTable({
                ...
                .buttons().container().appendTo('#categoriesDatatable_wrapper .col-md-6:eq(0)');
        });
    </script>
@endsection
