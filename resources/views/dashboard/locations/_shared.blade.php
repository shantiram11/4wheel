<script>
    ...
    {
        let table = 'locationDatatable';
        let action = BASE_URL+"/dashboard/dashboard-locations/"+id;
        $.ajax({
            "url": action,
            "dataType":"json",
            "type":"DELETE",
            ...
            success:function(resp){
                ...
                if(redirect){
                    alertifySuccessAndRedirect(resp.message, "{{route('dashboard-locations.index')}}");
                }else{
